...
>   literacidad digital[^5]. Sin embargo, no necesariamente son expertos en la adopción de nuevas
...
>    - Fricción (IHC): **Alto Abismo de Ejecución (Gulf of Execution)**[^4]. Falta de manipulación
...
>    - Fricción (IHC): **Abismo de Evaluación (Gulf of Evaluation)[^5] y cuellos de botella**. El ciclo
...
[^4]: Abismo de Ejecución: la dificultad de hacer que el sistema haga lo que quiero. Don Norman
[^5]: Abismo de Evaluación: la dificultad de saber si el sistema hizo lo que le pedí. Don Norman